...
export const GD_CONFIG = {
  ...
  export const DISEASE_CODE = {
    LAU: {
      name: "Lậu",
      description: "Lậu do vi khuẩn <i>Neisseria gonorrhoeae</i> gây ra. Nếu không chẩn đoán và điều trị kịp thời, có thể dẫn đến vô sinh, thai ngoài tử cung, hẹp đường tiểu...",
    },
    CHLAMYDIA: {
      name: "Chlamydia",
      description: "Chlamydia do vi khuẩn <i>Chlamydia trachomatis</i> gây ra. Nếu không chẩn đoán và điều trị kịp thời, có thể dẫn đến vô sinh, thai ngoài tử cung, hẹp đường tiểu...",
    },
    GIANGMAI: {
      name: "Giang mai",
      description: "Bệnh giang mai do xoắn khuẩn <i>Treponema pallidum</i> gây ra. Nếu không chẩn đoán và điều trị kịp thời, có thể gây ra tổn thương tim, não và hệ thần kinh, thậm chí gây tử vong. Ngoài ra, bệnh giang mai có thể lây truyền từ mẹ sang con.",
    },
    HSV: {
      name: "HSV",
      description: "HSV (Herpes Simplex Virus) là một loại vi-rút phổ biến gây mụn rộp quanh miệng (vi-rút HSV-1 ) và vùng sinh dục ( vi-rút HSV-2). Vi-rút HSV tồn tại suốt đời trong cơ thể và dễ tái phát. Nếu không điều trị, có thể gây ra viêm giác mạc mắt (gây mù) và viêm não. Đặc biệt, trẻ sơ sinh bị nhiễm HSV có nguy cơ tử vong cao.",
    },
    HIV: {
      name: "HIV", 
      description: "HIV là vi-rút gây Hội chứng suy giảm miễn dịch mắc phải (AIDS). Giai đoạn đầu thường chỉ có triệu chứng sốt nhẹ, đau nhức cơ thể như cúm nhưng sau đó tiềm ẩn lâu dài. Nếu không điều trị, HIV sẽ phá hủy hệ miễn dịch, dẫn đến các nhiễm trùng cơ hội, ung thư, và gây tử vong. Điều trị bằng thuốc kháng vi-rút có thể giúp bệnh nhân sống một cuộc đời khỏe mạnh và gần như bình thường.",
    },
    VIEM_GAN_B: {
      name: "Viêm gan B", 
      description: "HBV (Hepatitis B Virus) là vi-rút gây bệnh viêm gan B. Bệnh thường diễn biến âm thầm, không có triệu chứng rõ ràng. Nếu không điều trị, có thể dẫn đến xơ gan và ung thư gan, thậm chí đe dọa nghiêm trọng đến tính mạng. Hiện nay chúng ta đã có vắc-xin phòng ngừa viêm gan B, vì thế tầm soát và tiêm vaccine sớm là biện pháp phòng ngừa hiệu quả.",
    },
    VIEM_GAN_C: {
      name: "Viêm gan C",
      description: "HCV (Hepatitis C Virus) là vi-rút gây bệnh viêm gan C. Bệnh diến biến âm thầm và thường được chẩn đoán muộn. Nếu không điều trị, có thể dẫn đến xơ gan, suy gan và ung thư gan. Dù chưa có vắc-xin phòng ngừa, tuy nhiên bệnh có thể được trị khỏi hoàn toàn."
    },
    SUIMAOGA: {
      name: "Sùi mào gà",
      description: "HPV (Human Papillomavirus) là vi-rút lây truyền qua đường tình dục phổ biến, có thể gây sùi mào gà ở cơ quan sinh dục, hậu môn, miệng và lưỡi. Nếu không điều trị, một số chủng HPV có thể gây ung thư cổ tử cung, dương vật, hậu môn và hầu họng. Hiện nay chúng ta đã có vắc-xin phòng ngừa HPV, vì thế tầm soát và tiêm vaccine sớm là biện pháp phòng ngừa hiệu quả.", 
    }
